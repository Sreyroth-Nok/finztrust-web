document.write(`<header class="g s r vd ya cj" :class="{ 'hh sm _k dj bl ll' : stickyMenu }"
    @scroll.window="stickyMenu = (window.pageYOffset > 20) ? true : false">
    <div class="bb ze ki xn 2xl:ud-px-0 oo wf yf i">
      <div class="vd to/4 tc wf yf">
        <a href="index.html" class="flex items-center gap-2">
          <img src="images/LogoWithName.png" alt="FinzTrust" style="height: 32px; width: auto; max-width: 140px; display: inline-block; object-fit: contain;" />
        </a>
      ...
      <div id="premium-mobile-nav" class="vd wo/4 sd qo f ho oo wf yf" :class="{ 'd hh rm sr td ud qg ug jc yh': navigationOpen }">
        <nav>
          <ul class="tc _o sf yo cg ep">
            <li><a href="index.html" class="xl" :class="{'mk': page === 'home'}">Ecosystem</a></li>
            <li><a href="finzcore.html" class="xl" :class="{'mk': page === 'finzcore'}">FinzCore 360</a></li>
            <li><a href="rci-app.html" class="xl" :class="{'mk': page === 'rci-app'}">RCI App</a></li>
            <li><a href="finzloan.html" class="xl" :class="{'mk': page === 'finzloan'}">FinzLoan</a></li>
            <li><a href="about.html" class="xl" :class="{'mk': page === 'about'}">About Us</a></li>
          </ul>
        </nav>
        ...
        <div class="tc wf ig pb no">
          ...
          <a href="demo.html" class="demo-btn-nav">Request Demo</a>
        </div>
      </div>
    </div>
  </header>`);
